...
- **2025-10-15:** Dashboard reorganized by module - KPIs now grouped in clear sections: Visão Geral (overview), Propostas Comerciais (proposals), Recursos Humanos (HR), Obras e RDO (construction), and Financeiro e Custos (financial). Added gradient section headers for improved scannability and UX.
