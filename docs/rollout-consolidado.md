...
| `cronograma_editor_v2` | Editor de cronograma v2 (5 fases, 24/07; Fase 6 em 29/07) — **ligada em todo o parque em 03/08 pela migração 277** | ✅ `cronograma-editor-v2-rollout.md` | ✅ recusa calendário com sáb/dom (no `--ligar`; a 277 só avisa) |
...
- **`cronograma_editor_v2`** → `docs/cronograma-editor-v2-rollout.md`.
  ✅ **LIGADA EM TODO O PARQUE em 03/08** pela migração **277**, por decisão
