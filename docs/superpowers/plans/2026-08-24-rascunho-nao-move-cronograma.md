...
> **Estado em 2026-08-25 (varredura de fecho):** ✅ **FECHADO** — fechado em 24/08 (`95eb585f`). `atualizar_percentual_tarefa` e a irmã sem commit filtram `RDO.estado != rascunho`; `recalcular_percentuais_do_rdo` publica no Submeter e retira no Reabrir. 🔬 6/6 dos arquivos prometidos existem na árvore.
>
