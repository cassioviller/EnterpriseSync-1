...
- Três handlers de gravação redundantes: `salvar_rdo_flexivel` (`views/rdo.py:3851`, principal), `rdo_salvar_unificado` (`views/rdo.py:2513`, legado) e `crud_rdo_completo.salvar_rdo` (`:232`, legado) — os dois últimos **colidem na mesma URL `/rdo/salvar`**.
