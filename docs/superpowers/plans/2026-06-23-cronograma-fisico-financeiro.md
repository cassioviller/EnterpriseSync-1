...
> **Estado em 2026-08-25 (varredura de fecho):** ✅ **FECHADO** — 🔬 5/6. `templates/cronograma/obra.html` foi **apagado na limpeza** de templates mortos; o físico-financeiro vive em `templates/cronograma/fisico_financeiro.html`. 🔬 5/6 dos arquivos prometidos existem na árvore.
>
