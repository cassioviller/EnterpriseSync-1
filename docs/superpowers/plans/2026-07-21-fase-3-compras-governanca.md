...
> **Estado em 2026-08-25 (varredura de fecho):** ✅ **FECHADO** — fechada em 23/07. `utils/maquina_estados.py` nunca existiu com esse nome — a máquina mora em `services/`. 🔬 14/15 dos arquivos prometidos existem na árvore.
>
