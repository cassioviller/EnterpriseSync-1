...
> **Estado em 2026-08-25 (varredura de fecho):** ✅ **FECHADO** — fechada em 22/07. `templates/obras.html` consta como ausente porque foi **apagado na limpeza**, não porque falte trabalho. 🔬 22/23 dos arquivos prometidos existem na árvore.
>
