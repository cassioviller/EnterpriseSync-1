...
class TestConsoleSweep:
    ...
    ROTAS = [
        ...
        ("/crm/", "CRM"),
        ("/crm/lista", "CRM Lista"),
        ("/crm/cadastros", "CRM Cadastros"),
        ("/frota/", "Frota"),
        ("/frota/dashboard", "Frota Dashboard"),
        ("/equipe/", "Equipe"),
        ("/cronograma/", "Cronograma"),
        ("/cronograma/produtividade", "Cronograma Produtividade"),
        ("/usuarios", "Usuários"),
        # Cobertura de breadth — módulos do menu antes não exercitados.
        ("/alimentacao/dashboard", "Alimentação"),
        ("/cadastros/clientes/", "Clientes"),
        ("/catalogo/insumos", "Catálogo Insumos"),
        ("/catalogo/servicos", "Catálogo Serviços"),
        ("/manual/", "Manual"),
        ("/importacao/", "Importação"),
        ("/custos-escritorio/painel", "Custos Escritório"),
        ("/financeiro/fluxo-caixa", "Fluxo de Caixa"),
        ("/financeiro/bancos", "Bancos"),
        ("/financeiro/calendario-pagamentos", "Calendário Pagamentos"),
        ("/financeiro/contas-pagar", "Contas a Pagar"),
        ("/almoxarifado/saida", "Almox Saída"),
        ("/almoxarifado/devolucao", "Almox Devolução"),
