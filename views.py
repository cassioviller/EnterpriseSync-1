...
from models import db, Usuario, TipoUsuario, Funcionario, Obra, RDO, RDOAtividade, RDOMaoObra, RDOEquipamento, RDOOcorrencia, RDOFoto, AlocacaoEquipe, Servico, ServicoObra, SubAtividade
