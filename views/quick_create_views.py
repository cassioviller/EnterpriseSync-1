...
def _admin_id():
    ...
    Convergido em 01/09 (Task 11): o fallback devolvia current_user.id —
    um TENANT FANTASMA para usuário sem admin_id. require_tenant mantém o
    abort(401) para anônimo e falha FECHADO com 403 para o órfão, em vez
    de inventar tenant. Medido pelo censo de
