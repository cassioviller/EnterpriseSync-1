#!/usr/bin/env python3
"""
Script para adicionar admin_id na tabela funcao
...
def fix_funcao_admin_id():
    """Adiciona admin_id na tabela funcao"""
    ...
    logger.info("=" * 80)
    logger.info("🔧 CORREÇÃO: funcao.admin_id")
    logger.info("=" * 80)
    ...
    try:
        ...
        with engine.connect() as connection:
            ...
            connection.execute(text("""
                ...
                -- 2. Backfill usando funcionario.funcao_id
                UPDATE funcao fu
            ...
            row = result.fetchone()
            logger.info(f"✅ funcao.admin_id adicionado com sucesso")
