...
| `/veiculos/custo` | POST | `novo_custo_veiculo_lista` |
| `/veiculos/<int:id>/custo` | GET,POST | `novo_custo_veiculo` |
...
| `/veiculos/novo_OLD` | GET,POST | `novo_veiculo_OLD` |
| `/veiculos/<int:id>` | GET | `detalhes_veiculo` |
| `/veiculos/<int:veiculo_id>/uso/novo` | GET,POST | `novo_uso_veiculo` |
| `/veiculos/<int:veiculo_id>/custo/novo` | GET,POST | `novo_custo_veiculo_form` |
